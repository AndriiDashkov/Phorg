...
public class PaImageNewDialog extends JDialog {
	...
	private JPanel createGUI() {
		...
		m_subPanel = new PaSubjectsPanel(true, _temId, PaUtils.get().getSubjectsContainer(), getGuiStrs("subCaptionChooser")); //"���� ��� �����������: "
	...
	public void verifyInfo(String s) {
		...
		if (f.exists() == false) {
			...
			m_infoLabel.setText(getMessagesStrs("correctPathMessage"));//"� ����� ������ ���� �� ����������. ��������� ������������ ���� � �����.");
		}
		else {
